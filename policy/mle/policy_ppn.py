...
from policy.mle.policy import MyMLEPolicy

class MyMLEPolicyPPN(AbstractPPN):
    def __init__(self, module: MyMLEPolicy, system_state_dim: int) -> None:
        super().__init__(module=module, system_state_dim=system_state_dim)

    def _prepare_vocab(self):
        self.__vector = self.module.mle_policy.vector
